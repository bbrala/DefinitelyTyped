...
declare interface JQuery {
    contextMenu(options: JQueryContextMenu.ContextMenuOptions): JQuery;
    contextMenu(options?: string): JQuery;
    contextMenu(options?: boolean): JQuery;
    contextMenu(options?: { x: number, y: number, button?: string }): JQuery;
}

declare namespace JQueryContextMenu {
    ...
    const enum ContextMenuOptionsTrigger {
        right,
        left,
        hover,
        touchstart,
    ...
    const enum ContextMenuOptionsItemClickEvent {
        mouseup,
        click
    }
    ...
    interface ContextMenuBuildCallback {
        (e: JQuery.Event, $currentTrigger: JQuery): ContextMenuOptions
    }
    ...
    interface ContextMenuIconCallback {
        (e?: JQuery.Event, $item?: JQuery, key?: string, item?: ContextMenuItem, currentMenuData?: ContextMenuData, rootMenuData?: ContextMenuData): string
        (e?: JQuery.Event, $item?: JQuery, key?: string, item?: ContextMenuItem, currentMenuData?: ContextMenuData, rootMenuData?: ContextMenuData): void
    }
  ...
  submenu: {
    ...
    interface ContextMenuItem {
        ...
        name?: string,
        isHtmlName?: boolean,
        items?: { [key: string]: ContextMenuItem|string };
        className?: string,
        callback?: ContextMenuItemCallback,
